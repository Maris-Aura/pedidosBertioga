  ...
  return (
    ...
    >
      ...
      <section className="bg-white p-5 rounded-xl border">
        ...
        {pixPreview ? <div className="mt-3"><PixBlock payload={pixPreview} amount={total} /></div> : null}
        {paymentMethod === "cash" ? (
      ...
      <section className="bg-slate-900 text-white p-5 rounded-xl space-y-2">
        ...
        <button
          type="submit"
          disabled={submitting || !store.accepting_orders}
        ...
        >
          {store.accepting_orders ? "Enviar Pedido para a Loja" : "Loja fechada"}
        </button>
      </section>
    </form>
  );
