...
export function OrderCard({
  ...
  const message = `Olá ${order.customer_name}, seu pedido #${order.id.slice(-4).toUpperCase()} na ${store.name} foi confirmado! Status: ${ORDER_STATUS_LABEL[order.status]}.`;

  return (
    <article
      className={`bg-white rounded-xl p-5 shadow-sm space-y-4 border-2 ${
